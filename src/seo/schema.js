...
export function buildFestivalSchema({ seo, site }) {
...
export function buildSchemas({ seo, site, path, route }) {
  ...
  const schemas = [];
  if (requested.has("festival")) schemas.push(buildFestivalSchema({ seo, site }));
